...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<String> handleException(ReladomoMTLoaderException e) {
    ...
    public ResponseEntity<String> handleException(ReladomoConfigurationException e) {
        log.error("ReladomoConfigurationException was occurred. message={}", e.getMessage());
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(MESSAGE_INTERNAL_SERVER_ERROR);
    }

    @ExceptionHandler(Exception.class)
    public ResponseEntity<String> handleException(Exception e) {
        log.error("Exception was occurred. message={}", e.getMessage());
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(MESSAGE_INTERNAL_SERVER_ERROR);
    }
}
